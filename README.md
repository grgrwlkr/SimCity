...
- `Ctrl+Z` / `Ctrl+Y` (на Mac и `⌘`) — отменить / вернуть последнюю правку карты
...
- `Right` или `Middle click + drag` — сдвиг карты при любом инструменте; правый клик во время дороги сбрасывает её
