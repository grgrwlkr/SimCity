...
const EFFECTS: Readonly<Record<Exclude<ToolMode['kind'], 'Road' | 'Inspect'>, string>> = {
  ...
  Hospital: 'Больница',
  PowerPlant: 'Электростанция: ток идёт по дорогам, которых она касается',
  WaterPump: 'Водокачка: вода идёт по дорогам, которых она касается',
  Landfill: 'Свалка: мусор вывозят с дорог, которых она касается',
  School: 'Школа: поднимает образование вокруг',
  University: 'Университет: поднимает образование далеко вокруг',
  Park: 'Парк: поднимает здоровье вокруг',
