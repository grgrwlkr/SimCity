...
4. Замер: полный обход сетки в `updateTrafficIndex` из 2a стоил 0.24 мс на тик пустой карты и уронил e2e-фингерпринт по таймауту. Теперь обходятся только дорожные тайлы (<0.001 мс), e2e идёт 3.5 с в Chromium и 7.9 с в WebKit.
