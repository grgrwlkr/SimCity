...
| 1.3 | Land Value              | 🔴 High         | Средняя       | Высокое | —           |
| 2.1 | Многотайловые здания    | 🟡 Medium       | Высокая       | Высокое | 1.1         |
| 2.2 | Загрязнение             | 🟡 Medium       | Средняя       | Среднее | 1.3         |
...
1. **Уровни зданий** — визуальное развитие города
2. **Land Value** — экономическая глубина
3. **Время строительства** — ощущение прогресса
...
**Модули:** `src/game/buildings.rs`, `src/game/zone_placement.rs`, `src/game/demand.rs`, `src/game/employment.rs`, `src/game/services.rs`
