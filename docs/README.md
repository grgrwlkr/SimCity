...
Цели и планы работ. Это намерения, а не текущее состояние — сверяй с кодом.

- `plans/2026-09-09-gameplay-goals.md` — цели по игровой механике и UX/UI: паритет с SimCity, порядок фаз, осознанные отказы.
- `plans/2026-09-09-visual-goal.md` — утверждённая цель визуального апгрейда: стилизованный реализм, процедурная геометрия, один атлас.
- `plans/2026-09-09-visual-baseline.md` — замеры по фазам визуальной цели и протокол, по которому они снимаются.
- `plans/2026-07-12-pseudo3d-migration-roadmap.md` — миграция на псевдо-3D (завершена) и её пофазные планы.
