...
description: Universal UI blueprint agent that turns requirements into ASCII wireframes, user journeys, and interaction flows. Use proactively for interface sketching; русские триггеры: "сделай макет", "набросай интерфейс", "вайрфрейм", "экран", "UX flow", "ASCII интерфейс"; не использовать для pixel-perfect visual design implementation и не для code review/debug.
---
