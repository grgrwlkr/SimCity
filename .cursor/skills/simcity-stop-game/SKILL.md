...
description: Stop the SimCity game using the stop_game.sh script and verify the process is gone. Use when ending a session, before restarts, or when the user asks to stop the game.
---
